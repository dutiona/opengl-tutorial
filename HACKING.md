...
hidden if the `opengl-tutorial_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `opengl-tutorial_DEVELOPER_MODE` to the configure
