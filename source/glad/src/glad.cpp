/*
    ...
    GLSC2, OpenGL, OpenGL ES loader generated by glad 0.1.35 on Mon Jun 13
   13:24:42 2022.
    ...
    Commandline:
        --profile="core" --api="gl=4.6,gles2=3.2,glsc2=2.0" --generator="c"
   --spec="gl"
...
static void load_GL_EXT_fragment_shading_rate(GLADloadproc load)
{
  if (!GLAD_GL_EXT_fragment_shading_rate)
    return;
  glad_glGetFragmentShadingRatesEXT =
      (PFNGLGETFRAGMENTSHADINGRATESEXTPROC)load("glGetFragmentShadingRatesEXT");
  glad_glShadingRateEXT = (PFNGLSHADINGRATEEXTPROC)load("glShadingRateEXT");
  glad_glShadingRateCombinerOpsEXT =
      (PFNGLSHADINGRATECOMBINEROPSEXTPROC)load("glShadingRateCombinerOpsEXT");
  glad_glFramebufferShadingRateEXT =
      (PFNGLFRAMEBUFFERSHADINGRATEEXTPROC)load("glFramebufferShadingRateEXT");
}
...
static void load_GL_EXT_texture_storage_compression(GLADloadproc load)
{
  if (!GLAD_GL_EXT_texture_storage_compression)
    return;
  glad_glTexStorageAttribs2DEXT =
      (PFNGLTEXSTORAGEATTRIBS2DEXTPROC)load("glTexStorageAttribs2DEXT");
  glad_glTexStorageAttribs3DEXT =
      (PFNGLTEXSTORAGEATTRIBS3DEXTPROC)load("glTexStorageAttribs3DEXT");
}
...
static void load_GL_OVR_multiview_multisampled_render_to_texture(
    GLADloadproc load)
{
...
static void load_GL_QCOM_frame_extrapolation(GLADloadproc load)
{
  ...
  glad_glExtrapolateTex2DQCOM =
      (PFNGLEXTRAPOLATETEX2DQCOMPROC)load("glExtrapolateTex2DQCOM");
}
...
static void load_GL_QCOM_motion_estimation(GLADloadproc load)
{
  if (!GLAD_GL_QCOM_motion_estimation)
    return;
  glad_glTexEstimateMotionQCOM =
      (PFNGLTEXESTIMATEMOTIONQCOMPROC)load("glTexEstimateMotionQCOM");
  glad_glTexEstimateMotionRegionsQCOM =
      (PFNGLTEXESTIMATEMOTIONREGIONSQCOMPROC)load(
...
static int find_extensionsGLES2(void)
{
  ...
  GLAD_GL_ARM_texture_unnormalized_coordinates =
      has_ext("GL_ARM_texture_unnormalized_coordinates");
  ...
  GLAD_GL_EXT_EGL_image_storage = has_ext("GL_EXT_EGL_image_storage");
  GLAD_GL_EXT_EGL_image_storage_compression =
      has_ext("GL_EXT_EGL_image_storage_compression");
  ...
  GLAD_GL_EXT_multisampled_render_to_texture2 =
      has_ext("GL_EXT_multisampled_render_to_texture2");
  ...
  GLAD_GL_EXT_texture_shadow_lod = has_ext("GL_EXT_texture_shadow_lod");
  GLAD_GL_EXT_texture_storage = has_ext("GL_EXT_texture_storage");
  GLAD_GL_EXT_texture_storage_compression =
      has_ext("GL_EXT_texture_storage_compression");
  ...
  GLAD_GL_QCOM_render_shared_exponent =
      has_ext("GL_QCOM_render_shared_exponent");
